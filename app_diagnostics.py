...
AGENTIC_DIAGNOSTIC_PORT = int(os.environ.get("AGENTIC_DIAGNOSTIC_PORT", "8600"))
...
def _ensure_agentic_diagnostic_server() -> tuple[bool, str, int]:
    ...
    if not agentic_app.is_file():
        return False, (f"Full Diagnostics app.py was not found. Expected: {agentic_app}. "f"Set AGENTIC_DIAGNOSTIC_DIR or place the diagnostics project in general_diagnostics."), port
